...
module RSpec
  ...
  sig do
    params(
      name: T.any(Class, String, Symbol),
      args: T::Array[(T.any(T::Hash[Symbol, T.untyped], Symbol))],
      example_group_block: T.proc.bind(T.class_of(RSpec::Core::ExampleGroup)).void
    ).void
  end
  def self.describe(name, *args, &example_group_block); end
...
module RSpec::Core::MemoizedHelpers::ClassMethods
  ...
  sig do
    type_parameters(:T)
    .params(name: Symbol, block: T.proc.bind(RSpec::Core::ExampleGroup).returns(T.type_parameter(:T)))
...
class RSpec::Core::ExampleGroup
  ...
  sig do
    params(
      name: T.untyped,
      args: T::Array[(T.any(T::Hash[Symbol, T.untyped], Symbol))],
      customization_block: T.proc.bind(RSpec::Core::ExampleGroup).void
    ).void
  end
